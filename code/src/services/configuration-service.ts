        ...
        return new Promise<Configuration>(resolve => {
            storageService.get('CONFIGURATION').then((config: Partial<Configuration>) => {
                if (config) {
                    ...
                    if (config.showMateDistance === undefined) config.showMateDistance = DEFAULT_CONFIG.showMateDistance;
        ...
        return new Promise<Configuration>((resolve, reject) => {
            ...
            googleDriveService.getFile<Configuration>(GOOGLE_DRIVE_FOLDER, GOOGLE_DRIVE_CONFIG_FILE)
                .then((remoteConfig) => {
                    ...
                    if ('showMateDistance' in remoteConfig) self._configuration.showMateDistance = remoteConfig.showMateDistance;
