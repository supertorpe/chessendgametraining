...
const images = import.meta.glob('/node_modules/@ionic/core/dist/ionic/svg/(close|home-sharp|information-circle|settings-sharp|save|caret-down|caret-forward|caret-up|arrow-back|arrow-forward|power|bulb|color-wand|stop|trash|person|desktop-outline|clipboard-outline|logo-github|logo-discord|reload-outline|play|play-forward).svg', { as: 'url' });
